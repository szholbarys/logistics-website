...
const specs = [
  ...
  { label: 'Минимальный заказ', value: '5 тонн' },
              ...
              return (
                <StaggerItem key={item.name}>
                  <div className="group bg-card border border-border rounded-2xl p-6 h-full hover:border-primary/40 transition-colors duration-300">
                    ...
                    <h3 className="text-foreground font-bold mb-2">{item.name}</h3>
      ...
      <section className="py-24 bg-[oklch(0.09_0.01_250)]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { n: '01', title: 'Оставьте заявку', text: 'Заполните форму на сайте или позвоните — укажите маршрут и вес груза.' },
              { n: '02', title: 'Согласование', text: 'Менеджер уточнит детали, озвучит стоимость и подберёт подходящий транспорт.' },
              { n: '03', title: 'Подача транспорта', text: 'Транспорт подаётся в указанное место в согласованное время.' },
              { n: '04', title: 'Доставка и документы', text: 'Груз доставлен, выдан полный пакет документов.' },
            ].map((step) => (
              <FadeIn key={step.n} delay={parseInt(step.n) * 0.08}>
                <div className="bg-card border border-border rounded-2xl p-6 h-full">
                  <span className="text-primary/30 font-black text-4xl leading-none block mb-4">{step.n}</span>
              ...
              return (
                <FadeIn key={adv.title}>
                  <div className="group bg-card border border-border rounded-2xl p-6 h-full hover:border-primary/40 transition-colors duration-300">
                    ...
                    <h3 className="text-foreground font-bold mb-2">{adv.title}</h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <FadeIn>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                Стоимость грузоперевозки включает подачу транспорта, погрузку (при наличии
                погрузочной техники), перевозку до места назначения и выгрузку. Расчёт ведётся
                по весу или машинами.
              </p>
