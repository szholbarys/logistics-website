...
const deliveryServices = [
  {
    ...
    features: [
      'Фракции: 5–10, 10–20, 20–40, 40–70 мм',
      'Гранитный, известняковый, гравийный',
      'Минимальный заказ — 1 машина',
      'Доставка по всей Алматинской области',
    ],
  },
  {
    id: 'sand',
  ...
  },
  {
    ...
    description:
      'Песчано-гравийная и песчано-щебёночная смесь («Сникерс») — идеально для устройства дорожного полотна и оснований.',
    features: [
      'ПГС природная и обогащённая',
      'ПЩС («Сникерс») для дорог',
      'Отсев щебня, галька',
