...
const deliveryServices = [
  ...
  },
  {
    id: 'asphalt-concrete',
    name: 'Асфальтобетон',
    image: '/images/asphalt-concrete.jpeg',
    description:
      'Искусственный дорожно-строительный материал, получаемый уплотнением смеси щебня, песка, минерального порошка и битума.',
    features: [
      'Горячий и мелкозернистый асфальтобетон',
      'Для строительства и ремонта дорог',
      'Подходит для парковок, дворов и промышленных площадок',
      'Доставка на объект в согласованные сроки',
    ],
  }
]
